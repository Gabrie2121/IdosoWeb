...
function Favoritos() {
  ...
  return (
    <div>
      <Header
        one="MEU PERFIL"
        two="LISTA DE OFERTAS"
        three="LOGOUT"
        four=""
        linkOne="/profile-fisica"
        linkTwo="/listaofertas"
        linkThree="/"
        linkFour="/"
      />
      <DivBody>
        <DivSearch>
          <Items>
            <SpanFavoritos>Favoritos</SpanFavoritos>
          </Items>
          <Items>
            <SearchField />
          </Items>
        ...
        <DivProfiles>
          <DivProfileItem>
            <Profile />
            <SpanNome>Karina Alves</SpanNome>
            <ProfileImage src={karina} />
            <HeartImage src={heartImg} />
            <DivButton>
              <Button id="avaliadoButton" variant="contained" disabled>
                Avaliado
              </Button>
            </DivButton>
          </DivProfileItem>
          <DivProfileItem>
            <Profile />
            <SpanNome>Leonardo Machado Junior</SpanNome>
          ...
          <DivProfileItem>
            <Profile />
            <SpanNome>Sergio Jessé Garcia</SpanNome>
        ...
        >
          <Box sx={modalStyle}>
            <Button id="buttonDenunciar" variant="outlined">
              Denunciar
            </Button>
            <SpanAvaliacao>Avaliação</SpanAvaliacao>
            <DivIcone>
            ...
            <DivNomeAvaliado>
              <SpanNomeAvaliado>Eduarda C. Lorenzo</SpanNomeAvaliado>
            </DivNomeAvaliado>
            <DivRating>
              <Stack spacing={1}>
                <Rating
            ...
            <DivComentario>
              <SpanComentario>Comentário</SpanComentario>
            </DivComentario>
            <DivTextField>
              <TextField id="outlined-multiline-static" multiline rows={10} />
            </DivTextField>
            <SpanTexto>
              Gostei de cuidar da Sra. Camila, inclusive lembrou a minha avó.
              Jogamos muito Dominó.
            </SpanTexto>
            <DivEnviarAvaliacao>
              <Button
                onClick={handleOpen}
